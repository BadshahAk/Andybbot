...
logging.getLOGS("apscheduler").setLevel(logging.ERROR)
logging.getLOGS("telethon").setLevel(logging.ERROR)
logging.getLOGS("pyrogram").setLevel(logging.ERROR)
LOGS = logging.getLOGS("__name__")
