...
if ENV:
    ...
    from TeamLegend.config import Development as Config
...
telethn = TelegramClient("Kannadiga", API_ID, API_HASH)

pbot = Client("TeamLegend", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
